...
```{r}
Phase1 <- PressGaneyRaw1T[PressGaneyRaw1T$AdmitDateLocal >= "2014-01-01" & PressGaneyRaw1T$AdmitDateLocal <= "2016-12-31",]
```
...
```{r}
Phase2 <- PressGaneyRaw1T[PressGaneyRaw1T$AdmitDateLocal >= "2017-01-01" & PressGaneyRaw1T$AdmitDateLocal <= "2017-03-31",]
```
...
```{r}
Phase3 <- PressGaneyRaw1T[PressGaneyRaw1T$AdmitDateLocal >= "2017-04-01" & PressGaneyRaw1T$AdmitDateLocal <= "2018-10-30",]
View(Phase3)
```
